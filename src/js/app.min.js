...
var listManager = exports.listManager = function listManager() {
	...
	if (appListManager) {
		...
		// fires on page load
		(0, _loadList.loadList)(appNotificationEmpty, elementTable);
...
},{"./listManager/addItem":3,"./listManager/appNotification":4,"./listManager/deleteItem":5,"./listManager/getItem":6,"./listManager/loadList":7}],3:[function(require,module,exports){
"use strict";
...
var loadList = exports.loadList = function loadList(appNotificationEmpty, elementTable) {
