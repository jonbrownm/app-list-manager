...
var _initialiseList = require('./listManager/initialiseList');
...
var listManager = exports.listManager = function listManager() {
	...
	if (appListManager) {
		...
		(0, _initialiseList.initialiseList)(appNotificationEmpty, elementTable);
...
},{"./listManager/addItem":3,"./listManager/appNotification":4,"./listManager/deleteItem":5,"./listManager/getItem":6,"./listManager/initialiseList":7}],3:[function(require,module,exports){
"use strict";
...
},{"./returnItemId":8}],4:[function(require,module,exports){
"use strict";
...
exports.initialiseList = undefined;

var _appNotification = require("./appNotification");

var initialiseList = exports.initialiseList = function initialiseList(appNotificationEmpty, elementTable) {
...
},{"./appNotification":4}],8:[function(require,module,exports){
"use strict";
