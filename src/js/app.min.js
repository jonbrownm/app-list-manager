...
var listManager = exports.listManager = function listManager() {
	...
	if (appListManager) {
		...
		elementUserSubmit.addEventListener("click", function () {
			(0, _addItem.addItem)(elementTable, (0, _getItem.getItem)(elementUserInput), appNotification);
		});
		...
		elementTable.addEventListener("click", function (event) {
			...
			if (event.target.hasAttribute("data-item-delete")) {
				...
				(0, _deleteItem.deleteItem)(elementUserDelete, appNotification);
			}
		});
	}
};
...
var addItem = exports.addItem = function addItem(elementTable, elementUserInput, appNotification) {
	...
	if (elementUserInput) {
		...
		(0, _displayNotification.displayNotification)(appNotification, 0, "OFF");
		(0, _displayNotification.displayNotification)(appNotification, 2, "ON");
	} else {
		(0, _displayNotification.displayNotification)(appNotification, 1, "ON");
	}
};
...
var displayNotification = exports.displayNotification = function displayNotification(appNotification, errorMessage, errorState) {
	...
	var errorMessages = ["Your list is empty, please start entering them above.", "Please enter a valid entry.", "Your entry has been added to the list."];
...
var loadList = exports.loadList = function loadList(elementTable, appNotification) {
	...
	if (localStorage.length > 0) {
		...
		(0, _displayNotification.displayNotification)(appNotification, 0, "ON");
	}
};
